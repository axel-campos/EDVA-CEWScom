...
/**
 * Generador de plantillas HTML para la etapa de Conceptualización.
 */
public class ConceptualizacionTemplate implements MDOTemplate {

    private final String titulo;
    private final String version;

    public ConceptualizacionTemplate(String titulo, String version) {
        this.titulo = titulo;
        this.version = version;
    }
    
    public ConceptualizacionTemplate(Map<String,Object> detalles_contenido) {
    ...
    public String generarPlantilla(List<String> html) {
        try {
            ...
            Etapa etapa = new EtapaDAO().buscar(new Etapa().setIdEtapa((short) 2));
