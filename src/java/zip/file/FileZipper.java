...
/**
 * Código de https://www.mkyong.com/java/how-to-compress-files-in-zip-format/
...
public class FileZipper {
    ...
    /**
     * Comprime un folder o archivo recursivamente (Con todo su contenido
     * dentro). Incluso comprime folders vacios.
     *
     * @param source Ruta del archivo comprimido.
     * @param zipFile Ruta del directorio a comprimir.
     * @return Un dato boolean si tuvo exito o no la operación.
     * @throws java.io.IOException
     */
    public static boolean zip(String source, String zipFile) throws IOException {
    ...
    /**
     * Descomprime un archivo zip. Guarda el archivo en la misma ruta donde esta
     * el archivo a descomprimir.
     *
     * @param zipFile Ruta del directorio a desccomprimir.
     * @return Un dato boolean si tuvo exito o no la operación.
     * @throws java.io.IOException
     */
